...
fun LineChart(
    ...
    Canvas(
        ...
        val yLabel = (0..labelCountExcludingLastLabel).map {
            ValueLabel(
        ...
        val yLabelTextLayoutResults = yLabel.map {
            measurer.measure(
                text = it.formatted(),
                style = textStyle
            )
        ...
        // ******{ Drawing the line before the circles }******
