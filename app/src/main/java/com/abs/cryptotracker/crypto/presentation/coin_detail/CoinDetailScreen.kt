package com.abs.cryptotracker.crypto.presentation.coin_detail
...
import com.abs.cryptotracker.crypto.presentation.coin_detail.components.InfoCard
import com.abs.cryptotracker.crypto.presentation.coin_list.CoinListScreen
import com.abs.cryptotracker.crypto.presentation.coin_list.CoinListState
import com.abs.cryptotracker.crypto.presentation.coin_list.components.previewCoin
import com.abs.cryptotracker.crypto.presentation.models.toDisplayableNumber
import com.abs.cryptotracker.ui.theme.CryptoTrackerTheme
import com.abs.cryptotracker.ui.theme.greenBackground
    ...
    if (state.isLoading) {
        ...
        Column(
            ...
            AnimatedVisibility(
                ...
                var selectedDtaPoint by remember {
                ...
                LineChart(
                    ...
                    selectedDataPoint = selectedDtaPoint,
                    onSelectedDataPoint = {
                        selectedDtaPoint = it
                    },
